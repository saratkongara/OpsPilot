Feature: Fixed Service Assignment in FlightZone
  ...
  Scenario: Staff is eligible for multiple fixed services on a flight, but can only be assigned to one Fixed (F) service
    ...
    And the following service assignments exist:
      ...
      | 1  | 1          | 1             | 1           | 1           | FL101         | A+10           | A+40         | F            | 8.0      |
      | 2  | 2          | 1             | 1           | 1           | FL101         | D-40           | D-20         | F            | 7.5      |
  ...
  Scenario: Staff is eligible for multiple service types, and Fixed service has higher priority
    Given the following staff exists:
      | id | name  | department_id | certifications | eligible_for_services | shifts          |
      | 1  | Alice | 1             | [1, 2, 3]       | ['F', 'S']             | ['08:00-12:00'] |
    ...
    And the following service assignments exist:
      | id | service_id | department_id | staff_count | location_id | flight_number | relative_start | relative_end | service_type | priority |
      | 1  | 1          | 1             | 1           | 1           | FL200         | A+10           | A+30         | F            | 6.5      |
      | 2  | 2          | 1             | 1           | 1           | FL200         | A+50           | A+60         | F            | 7.0      |
      | 3  | 3          | 1             | 1           | 1           | FL200         | D-40           | D-20         | S            | 6.8      |
  ...
  Scenario: Staff is assigned to a Fixed service on the first flight, and is assigned the same service on the second flight
    ...
    And the following service assignments exist:
      | id | service_id | department_id | staff_count | location_id | flight_number | relative_start | relative_end | service_type | priority |
      | 1  | 1          | 1             | 1           | 1           | FL300         | A+10           | A+30         | F            | 1.0      |
      | 2  | 2          | 1             | 1           | 1           | FL300         | D-40           | D-10         | F            | 2.0      |
      | 3  | 1          | 1             | 1           | 1           | FL301         | A+10           | A+30         | F            | 3.0      |
      | 4  | 2          | 1             | 1           | 1           | FL301         | D-40           | D-10         | F            | 4.0      |
