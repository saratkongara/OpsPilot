Feature: Fixed Service Assignment in CommonZone
  ...
  Scenario: Staff is eligible for multiple fixed services in CommonZone, but can only be assigned to one with highest priority
    Given the following staff exists:
      | id | name  | certifications | eligible_for_services | shifts          |
      | 1  | Alice | [1, 2]         | ['F']                 | ['08:00-11:00'] |
    ...
    And the following service assignments exist:
      ...
      | 1  | 1          | 1           | 1           | 08:30      | 09:30    | F            | 2.0      |
      | 2  | 2          | 1           | 1           | 09:45      | 10:45    | F            | 1.0      |
  ...
  Scenario: Staff is eligible for fixed and non-fixed services, but Fixed has higher priority
    ...
    And the following service assignments exist:
      | id | service_id | staff_count | location_id | start_time | end_time | service_type | priority |
      | 1  | 1          | 1           | 1           | 08:30      | 09:30    | F            | 1.5      |
      | 2  | 2          | 1           | 1           | 09:45      | 10:45    | F            | 2.0      |
      | 3  | 3          | 1           | 1           | 10:00      | 10:30    | S            | 2.5      |
  ...
  Scenario: Staff is assigned to same fixed service across two non-overlapping CommonZone slots
    Given the following staff exists:
      | id | name  | certifications | eligible_for_services | shifts          |
    ...
    And the following service assignments exist:
      | id | service_id | staff_count | location_id | start_time | end_time | service_type | priority |
      | 1  | 1          | 1           | 1           | 08:15      | 09:15    | F            | 1.0      |
      | 2  | 2          | 1           | 1           | 09:25      | 10:15    | F            | 2.0      |
      | 3  | 1          | 1           | 1           | 10:30      | 11:30    | F            | 2.5      |
      | 4  | 2          | 1           | 1           | 11:45      | 12:00    | F            | 1.5      |
